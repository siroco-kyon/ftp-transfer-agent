...
- 🔒 **ハッシュ値による整合性検証**（MD5/SHA256/SHA512対応、SHA256/SHA512推奨）
...
| 項目 | 型 | 必須 | 説明 | デフォルト値 | 制約 |
|------|-----|------|------|--------------|------|
| Algorithm | string | ✓ | ハッシュアルゴリズム | "SHA256" | "MD5", "SHA256", "SHA512" |
...
- MD5ハッシュサポート復活：MD5/SHA256/SHA512をすべてサポート（セキュリティ考慮でSHA256/SHA512推奨）
